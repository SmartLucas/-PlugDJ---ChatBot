...
(function() {
  ...
  pupOnline = function() {
    return API.sendChat("NoNameBot On!!! version 1.0.0");
  };
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      var msg;
      msg = "Temas Permitidos : Tudo menos Funk ou Porn*.";
      return API.sendChat(msg);
    };
  ...
  rulesCommand = (function(_super) {
    ...
    rulesCommand.prototype.functionality = function() {
      var msg1 ;
      msg1 = "1- Tempo Maximo para Musicas : 5 Min. 2- Respeitar os administradores. 3-Sem Flood/Spam no chat. 4-Não fique pedindo cargo. ";
      msg1 +=5-Musicas Repetidas/Fora dos temas permitidos serão Puladas! 6- Não divulgar outras salas. 7- Falar apenas em BR/PT. 8- Não falar em amarelo. ";
      return API.sendChat(msg);
    };
  ...
  roomHelpCommand = (function(_super) {
    ...
    roomHelpCommand.prototype.functionality = function() {
      var msg1, msg2;
      msg1 = "Bem-vindo a Paranaue dos Minecraft para tocar escolha uma musica do Youtube ou SoundCloud.  ";
